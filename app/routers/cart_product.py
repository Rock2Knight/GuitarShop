...
from app.access.cart_product import access_cart_product
...
async def get_cart_product(
    ...
    cart_product_resp = await access_cart_product(**cart_product_dump)
...
async def create_cart_product(
    ...
    return await access_cart_product(**cart_product_dump)
